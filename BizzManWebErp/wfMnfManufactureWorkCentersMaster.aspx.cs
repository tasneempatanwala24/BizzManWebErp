    ...
    public partial class wfMnfManufactureWorkCentersMaster : System.Web.UI.Page
    {
            ...
            try
            {
              //  dtMaterialList = objMain.dtFetchData(@"select a.Id, a.KpiGroupId, b.KpiGroupName, a.KpiSubGroupName 
               ...
               //                    where a.KpiGroupId=b.Id and a.Id = " + Id + "");
                ...
                dtMaterialList = objMain.dtFetchData(@"select a.Id, a.BranchCode, b.BranchName,WorkCentersName,a.Address,a.ContactNo,a.Email
                                   from tblMnfWorkCentersMaster a, tblHrBranchMaster b
                                   where a.BranchCode=b.BranchCode and a.Id = " + Id + "");
            }
            catch (Exception ex)
            {
                // return "";
        ...
        public static string FetchMasterList()
        {
            ...
            try
            {
                ...
                dtEmpList = objMain.dtFetchData(@" select a.Id, a.BranchCode, b.BranchName,WorkCentersName,a.Address,a.ContactNo,a.Email
                                                  from tblMnfWorkCentersMaster a, tblHrBranchMaster b
        ...
        public static string CheckDataAvailability(string strSearchName, string isUpdate)
        {
            ...
            try
            {
                ...
                if (isUpdate == "0")
                {
                    ...
                    checkId = objMain.blSearchDataHO(string.Format("select 1 from tblMnfWorkCentersMaster where WorkCentersName='{0}'", strSearchName));
                }
                else
                {
                    checkId = false;
